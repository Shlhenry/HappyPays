...
import com.futeng.happypays.activity.erweima.WechatD0Activity;
...
public class ZxingMainActivity extends Activity implements EasyPermissions.PermissionCallbacks{
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Toast.makeText(ZxingMainActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                }
            }
        }
                ...
                try {
                    CodeUtils.analyzeBitmap(ImageUtil.getImageAbsolutePath(this, uri), new CodeUtils.AnalyzeCallback() {
                        ...
                        public void onAnalyzeSuccess(Bitmap mBitmap, String result) {
                            Toast.makeText(ZxingMainActivity.this, "解析结果:" + result, Toast.LENGTH_LONG).show();
                        }
    ...
    class ButtonOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.button2) {
                ...
                Intent intent = new Intent(ZxingMainActivity.this, WechatD0Activity.class);
    ...
    private void onClick(int buttonId) {
        switch (buttonId) {
            case R.id.button1:
                ...
                break;
            case R.id.button3:
                intent = new Intent(ZxingMainActivity.this, ZxingSecondActivity.class);
                startActivityForResult(intent, REQUEST_CODE);
                break;
            default:
                break;
