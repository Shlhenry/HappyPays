...
public class WaterNoCardActivity extends Fragment {

    @InjectView(R.id.nocardmoney_back)
    ImageView nocardmoneyBack;
    @InjectView(R.id.nocardwater_lv_list)
    ListView nocardwaterLvList;
...
//        setContentView(R.layout.activity_water_no_card);
//        ButterKnife.inject(this);
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_water_no_card, container, false);
        ...
        nocardwaterLvList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if ("".equals(zfbtran37) || zfbtran37 == null) {
                    ...
                    SPUtils.put(getActivity(), "uptype", "4");
    ...
    private void initRefresh() {
        xRefreshView = (XRefreshView)view.findViewById(R.id.nocard_view);
    ...
    private void initView() {
        ...
        nocardwaterLvList.setAdapter(shopwaterAdapter);
