...
public class InteralChangeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_interal_change_fragment, container, false);
    ...
    private void getSubjectList(final int loadtype, String amNumber, int waterType, int count) {
        ...
        map.put("count", count);
        map.put("awtIds", "15,16,17,18,19,21");
