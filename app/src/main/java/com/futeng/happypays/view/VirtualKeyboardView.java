package com.futeng.happypays.view;
...
import com.futeng.happypays.adapter.KeyBoardAdapter;
...
public class VirtualKeyboardView extends RelativeLayout {
    ...
    public VirtualKeyboardView(Context context, AttributeSet attrs) {
        ...
        keyboard_ok= (Button) view.findViewById(R.id.keyboard_ok);
